...
the [Integration Tests documentation](https://github.com/google-gemini/gemini-cli/blob/main/docs/integration-tests.md).
...
2.  **Install and run React DevTools version 4.28.5 (or the latest compatible
    ...
    ![](https://github.com/google-gemini/gemini-cli/blob/main/docs/assets/connected_devtools.png)
...
- Check our [FAQ](https://github.com/google-gemini/gemini-cli/blob/main/docs/faq.md).
