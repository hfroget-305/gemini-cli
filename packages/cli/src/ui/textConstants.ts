...
export const SCREEN_READER_SHELL_PREFIX = '[shell] ';
...
export const SCREEN_READER_PREFIX_WIDTH = 11;
export const VISUAL_PREFIX_WIDTH = 2;
export const VISUAL_DIAGNOSTIC_PREFIX_WIDTH = 3;
